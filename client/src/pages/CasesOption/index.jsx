    ...
    <React.Fragment>
      <div className="cases-container">
        <div className="uk-container">
          <div className="title">
            <h1>What the <span style={{color: '#4cd137', fontWeight: 700}}>cases</span> ?</h1>
          </div>
          <div className="cases-contents">
            <div className="cases-content">
              <div className="uk-card uk-card-default uk-card-hover uk-card-body abuse-of-power">
            ...
            <div className="cases-content">
              <div className="uk-card uk-card-default uk-card-hover uk-card-body employment">
                <h2>Employment</h2>
                <ul className="uk-list">
            ...
            <div className="cases-content">
              <div className="uk-card uk-card-default uk-card-hover uk-card-body hover">
                <h2>Hover</h2>
                <ul className="uk-list">
            ...
            <div className="cases-content">
              <div className="uk-card uk-card-default uk-card-hover uk-card-body bribery">
                <h2>Bribery</h2>
                <ul className="uk-list">
