...
describe("GET REPORTS", () => {
  ...
  const report = { 
    UserId: "5fd4fa8a2e6d3626001d530a", 
    case: "corruption", 
    entity: "Indonesian",
    province: "DKI Jakarta",
    city: "Jakarta Pusat",
    dateHappened: "01/01/2020",
    description: "Sri Mulyani Heran, Tunjangan PNS Naik Tapi Masih Ada 'Suap'",
    isDocumentProvided: true,
    involvedPerson: ["Sri mulyani"] ,
    personRole: "manager",
    isReported: true,
    isKeepInTouch: true 
  }
  ...
  it("get reports with status 200", (done) => {
    request.get('/')
      .send({
        query: `{reports { _id UserId case entity province city dateHappened description isDocumentProvided involvedPerson personRole isReported isKeepInTouch }}`
      })
  ...
  it("get reports with all property", (done) => {
    request.get('/')
      ...
      .end((err, res) => {
        ...
        expect(res.body.data.reports[0]).toHaveProperty("UserId", expect.any(String));
        ...
        expect(res.body.data.reports[0]).toHaveProperty("isDocumentProvided", expect.any(Boolean));
        ...
        expect(res.body.data.reports[0]).toHaveProperty("isReported", expect.any(Boolean));
        expect(res.body.data.reports[0]).toHaveProperty("isKeepInTouch", expect.any(Boolean));
        done();
      })
  })
...
describe("GET REPORT BY ID", () => {
  ...
  it("success get report by id with all property", (done) => {
    request.get('/')
      .send({
        query: `{ report(_id: "${idWantToDelete}") { _id UserId case entity province city dateHappened description isDocumentProvided involvedPerson personRole isReported isKeepInTouch } }`
      })
      .set("Accept", "application/json")
      .end((err, res) => {
        if (err) return done(err)
        expect(res.body.data.report).toHaveProperty("_id", expect.any(String));
        expect(res.body.data.report).toHaveProperty("UserId", expect.any(String));
        ...
        expect(res.body.data.report).toHaveProperty("isDocumentProvided", expect.any(Boolean));
        ...
        expect(res.body.data.report).toHaveProperty("isReported", expect.any(Boolean));
        expect(res.body.data.report).toHaveProperty("isKeepInTouch", expect.any(Boolean));
        done();
      })
  })
  ...
  it("failed get report by id cause id dont match with any report", (done) => {
    request.get('/')
      .send({
        query: `{ report(_id: "5fd592fc4cgcfe2628ca5f12") { _id UserId case entity province city dateHappened description isDocumentProvided involvedPerson personRole isReported isKeepInTouch } }`
      })
      .set("Accept", "application/json")
      .end((err, res) => {
        if (err) return done(err)
  ...
  it("failed get report by id cause unknown agrument id", (done) => {
    request.get('/')
      .send({
        query: `{ report(id: "5fd592fc4cgcfe2628ca5f12") { _id UserId case entity province city dateHappened description isDocumentProvided involvedPerson personRole isReported isKeepInTouch } }`
      })
      .set("Accept", "application/json")
      .end((err, res) => {
        if (err) return done(err)
...
describe("INSERT NEW REPORT", () => {
  ...
  afterEach( async () => {
    db.collection('Reports').deleteOne({ "UserId" : "5fd4fa8a2e6d3626001d530a" })
  })
  ...
  it("success insert report with validate", (done) => {
    request.post('/')
      ...
      .end((err, res) => {
        ...
        expect(res.body.data.AddReport).toHaveProperty("UserId", expect.any(String));
        ...
        expect(res.body.data.AddReport).toHaveProperty("isDocumentProvided", expect.any(Boolean));
        ...
        expect(res.body.data.AddReport).toHaveProperty("isReported", expect.any(Boolean));
        expect(res.body.data.AddReport).toHaveProperty("isKeepInTouch", expect.any(Boolean));
        done();
      })
  })
  ...
  it("success update with validate data", (done) => {
    request.post('/')
      ...
      .end((err, res) => {
        ...
        expect(res.body.data.UpdateReport).toHaveProperty("UserId", expect.any(String));
        ...
        expect(res.body.data.UpdateReport).toHaveProperty("isDocumentProvided", expect.any(Boolean));
        ...
        expect(res.body.data.UpdateReport).toHaveProperty("isReported", expect.any(Boolean));
        expect(res.body.data.UpdateReport).toHaveProperty("isKeepInTouch", expect.any(Boolean));
        done();
      })
  })
...
describe("DELETE REPORT", () => {
  ...
  it("success delete report with status 200", (done) => {
    request.post('/')
      .send({
        query: `mutation {DeleteReport(_id: "${idWantToDelete}") { _id UserId case entity province city dateHappened description isDocumentProvided involvedPerson personRole isReported isKeepInTouch }}`
      })
      .set("Accept", "application/json")
      .end((err, res) => {
        if (err) return done(err)
  ...
  it("success delete report with valid data", (done) => {
    request.post('/')
      ...
      .end((err, res) => {
        ...
        expect(res.body.data.DeleteReport).toHaveProperty("UserId", expect.any(String));
        ...
        expect(res.body.data.DeleteReport).toHaveProperty("isDocumentProvided", expect.any(Boolean));
        ...
        expect(res.body.data.DeleteReport).toHaveProperty("isReported", expect.any(Boolean));
        expect(res.body.data.DeleteReport).toHaveProperty("isKeepInTouch", expect.any(Boolean));
        done();
      })
  })
  ...
  it("failed delete cause id dont match with any report", (done) => {
    request.post('/')
      .send({
        query: `mutation {DeleteReport(_id: "5fd5b75753ffd64b788d0dee") { _id UserId case entity province city dateHappened description isDocumentProvided involvedPerson personRole isReported isKeepInTouch }}`
      })
      .set("Accept", "application/json")
      .end((err, res) => {
        if (err) return done(err)
